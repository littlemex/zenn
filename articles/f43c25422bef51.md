...
まず、[最新のNeuron Deep Learning AMI (DLAMI) for Trainium/Inferentia](https://awsdocs-neuron.readthedocs-hosted.com/en/latest/setup/neuron-setup/multiframework/multi-framework-ubuntu22-neuronlami.html#setup-ubuntu22-multi-framework-dlami)を使用して[EC2インスタンスを起動](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/LaunchingAndUsingInstances.html)します。インスタンスが起動したら、インスタンスにSSH接続し、仮想環境をアクティベートします。
