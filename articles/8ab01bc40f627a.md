...
今回はぐちゃぐちゃになり散らかしていたローカルのディレクトリを見て発狂したことをきっかけにプロファイルの仕組みを作ってみました。まだ作ったばかりで穴だらけですが今後使いながら改良していきます。S3 Files とマネージド MLflow は採用の必然性は別にありません、好きなものを使えば良いと思います。