...
① AgentCore Evaluations がどういうもので他の AWS サービスとどのような関係があるのか、② Tool use と Memory に関する組み込み評価にどのようなものがあるのか、③ 実際に AgentCore Evaluations を動かしてみる、④ Strands Evals との関係、の 4 点を整理した。
