...
::::details Optimized Collective Communication Initialization の技術仕様
...
学習データを永続的なメモリマップドキャッシュに保持することで、プロセス再起動時の最初のバッチ生成時間をゼロにします。メモリマップド I/O により、GPU 8 台の p5 インスタンスでは、データコピーを 8 個から 1 個に削減できます。
