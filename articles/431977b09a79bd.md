...
MoE のより詳細や学習側については ( ´･ω･)⊃ ｽｯ https://arxiv.org/html/2507.11181v2
...
MoE 推論についてふんわり理解しました。今回の記事は「分散推論の課題」を今後深掘りするための背景的な解説記事です。次回以降の記事では、1. **TransferEngine**: EFA の制約を克服する RDMA 通信ライブラリ、**DeepEP**: Expert Parallelism の最適化、など以下の記事で初見でそっ閉じした内容を整理していきます。 ﾟ(ﾟ`ω´ ﾟ)ﾟ
