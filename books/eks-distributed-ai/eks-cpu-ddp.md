...
```bash
kubectl logs -f job/smollm-torchrun -n <your-namespace>
```
...
```bash
kubectl wait --for=condition=complete job/smollm-torchrun -n <your-namespace> --timeout=20m
```

## 4. 後片付け

```bash
kubectl delete job smollm-torchrun -n <your-namespace>
```
