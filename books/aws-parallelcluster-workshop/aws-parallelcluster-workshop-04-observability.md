...
## Grafana + AMP スタックのデプロイ

**デプロイされるリソース**

Security Group と IAM ロールは省略します。
...
# Open port 8080 on Head Node security group
...
本章では、Amazon Managed Prometheus を使った可観測性スタックを構築しました。この後の作業は公式ワークショップを確認してみてください。